...
if (NOT TARGET ${cclsystem})
	...
	if (NOT ${CCL_STATIC_ONLY})
		...
		if (CCL_EXPORTS_PATH)
			install (TARGETS ${cclsystem} EXPORT ccl-targets FILE_SET HEADERS DESTINATION ${CCL_PUBLIC_HEADERS_DESTINATION}  COMPONENT public_headers
...
if (VENDOR_APPLICATION_RUNTIME_DIRECTORY AND NOT CCL_SYSTEM_INSTALL)
	ccl_install_imported (${cclsystem} LIBRARY DESTINATION "${VENDOR_APPLICATION_RUNTIME_DIRECTORY}"
									   RUNTIME DESTINATION "${VENDOR_APPLICATION_RUNTIME_DIRECTORY}"
									   FRAMEWORK DESTINATION "${VENDOR_APPLICATION_RUNTIME_DIRECTORY}"
	)
endif ()
