...
//
// Filename    : ccl/platform/linux/text/unicodestring.linux.h
// Description : Unicode String Implementation using GNU libunistring
//
//************************************************************************************************

#ifndef _unicodestring_linux_h
#define _unicodestring_linux_h
...
class LinuxUnicodeString: public UnicodeStringBuffer
{
public:
	// UnicodeStringBuffer
...
class LinuxUnicodeUtilities: public UnicodeUtilities
{
public:
	uint32 toUtf32 (uchar c) const;
