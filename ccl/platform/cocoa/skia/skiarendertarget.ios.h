...
//
// Filename    : ccl/platform/cocoa/skia/skiarendertarget.ios.h
...
class MetalIOSWindowRenderTarget: public MetalWindowRenderTarget
{
public:
	MetalIOSWindowRenderTarget (Window& window);
	~MetalIOSWindowRenderTarget ();
