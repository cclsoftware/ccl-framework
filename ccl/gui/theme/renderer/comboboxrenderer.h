...
//
// Filename    : ccl/gui/theme/renderer/comboboxrenderer.h
// Description : Control Renderer
//
//************************************************************************************************

#ifndef _ccl_comboboxrenderer_h
#define _ccl_comboboxrenderer_h
...
class ComboBoxRenderer: public CompositedRenderer
{
public:
	ComboBoxRenderer (VisualStyle* visualStyle);
...
DECLARE_VISUALSTYLE_CLASS (ComboBox)
