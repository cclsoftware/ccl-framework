...
macro (ccl_evaluate_macros file)
	...
	if (NOT buildnumber_file)
		...
		if (TARGET corelib)
			target_include_directories (corelib PUBLIC "$<BUILD_INTERFACE:${buildnumber_include_dir}>")
		endif ()
	endif ()
	...
	if (NOT buildtime_file)
		...
		if (TARGET corelib)
			target_include_directories (corelib PUBLIC "$<BUILD_INTERFACE:${buildtime_include_dir}>")
		endif ()
	endif ()
