...
option (VENDOR_USE_PUBLISHER_CERTIFICATE OFF)

set (VENDOR_ENABLE_LINK_TIME_OPTIMIZATION OFF CACHE BOOL "Enable link time optimization for release builds. Always disabled for Mac/iOS." FORCE)

# Installation directories
set (VENDOR_APPLICATION_RUNTIME_DIRECTORY ".." CACHE STRING "Bundle root" FORCE)
set (VENDOR_PLUGINS_RUNTIME_DIRECTORY "${VENDOR_APPLICATION_RUNTIME_DIRECTORY}/PlugIns" CACHE STRING "Plug-in installation directory" FORCE)
...
set (CMAKE_XCODE_ATTRIBUTE_CODE_SIGN_ALLOW_ENTITLEMENTS_MODIFICATION "$<IF:$<CONFIG:DEBUG>,YES,NO>")
set (CMAKE_XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "")
set (CMAKE_XCODE_ATTRIBUTE_ENABLE_HARDENED_RUNTIME "YES")
set (CMAKE_XCODE_ATTRIBUTE_CODE_SIGN_INJECT_BASE_ENTITLEMENTS "$<IF:$<CONFIG:DEBUG>,YES,NO>")
...
set (CMAKE_XCODE_ATTRIBUTE_GCC_OPTIMIZATION_LEVEL "$<IF:$<CONFIG:DEBUG>,0,3>")
add_compile_options ("-arch;$(arch)") # this is needed to make ccache process compile options like -Xarch_<arch> <option>
