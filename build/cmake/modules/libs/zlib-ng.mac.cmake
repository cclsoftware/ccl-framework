...
foreach (arch IN ITEMS ${VENDOR_TARGET_ARCHITECTURE})
    if ("${arch}" MATCHES "(x86_64)")
		set_source_files_properties (${ZLIBNG_INCLUDE_DIR}/arch/x86/chorba_sse2.c PROPERTIES COMPILE_OPTIONS "-Xarch_x86_64;-msse2")
		...
		set_source_files_properties (${ZLIBNG_INCLUDE_DIR}/arch/x86/chorba_sse41.c PROPERTIES COMPILE_OPTIONS "-Xarch_x86_64;-msse4.1")
		...
		set_source_files_properties (${ZLIBNG_INCLUDE_DIR}/arch/x86/compare256_avx512.c PROPERTIES COMPILE_OPTIONS "-Xarch_x86_64;-mavx512f;-Xarch_x86_64;-mavx512bw;-Xarch_x86_64;-mavx512vl")
        ...
        set_property (TARGET zlib-ng PROPERTY XCODE_ATTRIBUTE_GCC_PREPROCESSOR_DEFINITIONS[arch=x86_64] "$(inherited) X86_FEATURES X86_SSE2 X86_SSSE3 X86_SSE41 X86_SSE42 X86_AVX2 X86_AVX512 X86_AVX512VNNI X86_PCLMULQDQ_CRC X86_VPCLMULQDQ_CRC")
